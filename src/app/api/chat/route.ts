...
You must respond with valid JSON in the following format:
{
  ...
  "sources": [{ // only show 1 max
    ...
    "name": "name", // page title of the source, ie for case studies it is the 'name' field ie " "name": "How[...]",", and for other pages it is the object key [use Offerings, Index, Showroom, About]
    }],
